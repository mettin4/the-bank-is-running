...
export const zh: Dict = {
  ...
  'land.h1': '他们称之为人民的中央银行。',
  'land.s1': '没有董事会 · 没有委员会 · 4000行代码',
  'land.h2': '它只看一件事：资金流入，资金流出。',
  'land.s2': '单一池子的ETH净流量 · 银行唯一的输入',
  'land.h3': '资金流入。银行放松政策，囤积黄金。',
  'land.s3': '利率逐步上调 · 手续费购入代币化黄金',
  'land.h4': '资金流出。银行立即降息，回购销毁。',
  'land.s4': '降息即时生效 · 手续费回购并销毁',
  'land.h5': '如果所有人挤兑？离场者付钱给留守者。',
  'land.s5': '退出费随挤兑上升 · 一半销毁 · 一半分给留守者',
  'land.h6': '银行尚未上线。这个网站就是白皮书的运行版本。',
  'land.s6': '1000家银行 · 合成市场 · 所有假设均已标注',
  'land.tag.autonomous': '自主运行',
  'land.tag.immutable': '不可更改',
  'land.tag.lines': '4000 行',
  'land.tag.pool': '单一池子',
  'land.tag.in': '流入',
  'land.tag.out': '流出',
  'land.tag.net': '净流量',
