...
export const en = {
  ...
  'land.h1': "They call it the people's central bank.",
  'land.s1': 'NO BOARD · NO COMMITTEE · 4,000 LINES OF CODE',
  'land.h2': 'It watches one thing: money in, money out.',
  'land.s2': "NET ETH FLOW THROUGH ONE POOL · THE BANK'S ONLY INPUT",
  'land.h3': 'Money flows in. The bank loosens, and stacks gold.',
  'land.s3': 'RATE RISES STEP BY STEP · FEES BUY TOKENIZED GOLD',
  'land.h4': 'Money leaves. The bank cuts, and burns.',
  'land.s4': 'CUTS ARE INSTANT · FEES BUY BACK AND BURN',
  'land.h5': 'And if everyone runs? Leavers pay the stayers.',
  ...
  'land.alt1': 'A bank whose columns are code brackets',
